...
name = 'victor' # put the subjects' names in here
...
zoom = False 
chock = 'victor_bas_sans_001', 1 # choc sur lequel zoomer: bloc, choc    
...
if Add or delai: 
    ...
    gbio.make_plots(start,end,Name=name,add=Add,Delai=delai,Type=ttype) 
